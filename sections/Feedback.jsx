  ...
  <section className={`${styles.paddings}`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26px] sm:leading-[40.32px] leading-[36.32px] text-blue-400">
            New to Bitcoin Ordinals?
          </h4>
      ...
      >
        ...
        >
          <img
            src="/ordinalroo.jpg"
            alt="stamp"
            className="w-[155px] h-[155px] object-contain rounded-full opacity-80"
          />
        </motion.div>
      </motion.div>
    </motion.div>
